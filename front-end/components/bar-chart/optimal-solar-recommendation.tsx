    ...
    <div>
      <div className="tableauPlaceholder" id="viz1633255846922" style={{ position: 'relative' }}>
        <noscript>
          <a href="#">
            <img
              alt="Optimal Total Solar Irradiance at My Location Dashboard "
              src="https://public.tableau.com/static/images/PB/PBXCPCZJ9/1_rss.png"
              style={{ border: 'none' }}
            />
          </a>
        </noscript>
        <object className="tableauViz" style={{ display: 'none' }}>
          ...
          <param name="embed_code_version" value="3" /> <param name="path" value="shared/PBXCPCZJ9" />{' '}
          <param name="toolbar" value="yes" />
          <param name="static_image" value="https://public.tableau.com/static/images/PB/PBXCPCZJ9/1.png" />{' '}
